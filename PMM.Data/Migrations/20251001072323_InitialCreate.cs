        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedDeadline = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PlannedHours = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EndAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExpectedHours = table.Column<int>(type: "integer", nullable: true),
                    SpentHours = table.Column<int>(type: "integer", nullable: true),
                    CreatedById = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedById = table.Column<int>(type: "integer", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignments_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignments_UpdatedById",
                table: "ProjectAssignments",
                column: "UpdatedById");
