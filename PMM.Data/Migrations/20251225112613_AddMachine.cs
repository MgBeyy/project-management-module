        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Machines_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Machines_Users_UpdatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Machines_DeletedById",
                table: "Machines",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_Machines_UpdatedById",
                table: "Machines",
                column: "UpdatedById");
        }
